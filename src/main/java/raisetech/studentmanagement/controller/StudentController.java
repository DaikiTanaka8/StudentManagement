...
public class StudentController {
  ...
  public StudentDetail getStudent(@PathVariable @Size(min = 1,max = 36) String studentId) { //MEMO: ID情報を持ってないといけない→「@PathVariable」：URLの一部から受け取るときに使う。今回は{student_id}だね。
  ...
  /**
   * 受講生詳細の削除（論理削除）を行います。
   * //MEMO: 課題30で作った受講生削除メソッド（自作）。studentDetail→studentIdに変更。
